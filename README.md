...
- **Audio everywhere** — every character, word, and phrase is spoken aloud in Japanese (uses the iPad's built-in Japanese voice, Kyoko). Cats meow too.
- **Cat collection** — 22 unlockable cartoon cat breeds (calico, siamese, ninja cat, space cat, rainbow cat, dragon cat…), 20 outfits, and 8 cat moves/animations. Cats randomly stroll across the screen, and a tiny cat walks along the progress bar during lessons.
- **Cat Shop** — earn 🐟 fish from lessons and spend them on outfits.
...
4. After a minute your app is live at `https://<username>.github.io/kittykana/`.
